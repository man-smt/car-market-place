...
import { ISSUER, LOCATIONS } from '../../graphql/Queries'
...
const HomePage = ({ name }) => {
  ...
  useEffect(() => {
    client
      .query({ query: ISSUER })
      .then((res) => {
        localStorage.setItem('accessToken', res?.data?.issue?.accessToken)
      })
  ...
  const searchSpecification = () => {
    ...
    if (searchSelectData?.brand) {
      array.push(searchSelectData?.brand)
    }

    if (searchSelectData?.brand || searchSelectData?.model || searchData) {
      searchObj['product'] = {
        productSpecifications: {
          some: {
            specificationValue: { slug: { in: array } },
          },
        },
      }
    } else {
    ...
    if (searchSelectData?.location) {
      searchObj['locationSpecifications'] = {
        some: {
          locationValue: { slug: { contains: searchSelectData?.location } },
        },
      }
    }

    if (searchSelectData?.body_type) {
      searchSelectData?.body_type
        ? (searchObj['advertiseSpecifications'] = {
            some: {
              specificationValue: {
                slug: { contains: searchSelectData?.body_type },
              },
            },
          })
    ...
    //   searchSelectData?.model
    //     ? {
    //         product: {
    //           productSpecifications: {
    //             some: {
    //               specificationValue: {
    //                 slug: { eq: searchSelectData?.model },
    ...
    //         },
    //       }
    //     : delete searchObj.model
    //   searchSelectData?.body_type
    //     ? {
    //         advertiseSpecifications: {
    //           some: {
    //             specificationValue: {
    //               slug: { in: searchSelectData },
    //             },
    //           },
    //         },
    //       }
  ...
  const categories = [
    [
      '/car-finder/catalog?view=list',
      '/images/car-finder/icons/sedan.svg',
      'Sedan',
    ],
    [
      '/car-finder/catalog?view=grid',
      '/images/car-finder/icons/suv.svg',
      'SUV',
    ],
    [
      '/car-finder/catalog?view=list',
      '/images/car-finder/icons/wagon.svg',
      'Wagon',
    ],
    [
      '/car-finder/catalog?view=grid',
      '/images/car-finder/icons/crossover.svg',
      'Crossover',
    ],
    [
      '/car-finder/catalog?view=list',
      '/images/car-finder/icons/coupe.svg',
      'Coupe',
    ],
    [
      '/car-finder/catalog?view=grid',
      '/images/car-finder/icons/pickup.svg',
      'Pickup',
    ],
    [
      '/car-finder/catalog?view=list',
      '/images/car-finder/icons/sport.svg',
      'Sport Coupe',
    ],
    [
      '/car-finder/catalog?view=grid',
      '/images/car-finder/icons/compact.svg',
      'Compact',
    ],
    [
      '/car-finder/catalog?view=list',
      '/images/car-finder/icons/convertible.svg',
      'Convertible',
    ],
    [
      '/car-finder/catalog?view=grid',
      '/images/car-finder/icons/mpv.svg',
      'Family MPV',
    ],
  ]
  ...
  return (
    <CarFinderPageLayout pageTitle='Home' activeNav='Home'>
      {/* Hero + Search form */}
      <section
        className='bg-top-center bg-repeat-0 pt-5'
        style={{
          backgroundImage: 'url(/images/car-finder/home/hero-bg.png)',
      ...
      >
        ...
        <Container className='mt-4 mt-sm-3 mt-lg-n3 pb-5 mb-md-4'>
          {/* Tabs */}
          <Nav variant='tabs' className='nav-tabs-light mb-4'>
            <Nav.Item>
              <Nav.Link
                value='new'
                eventKey='new'
                href={`/car-finder/catalog?view=grid&newSearch=new`}
              >
                New
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
                value='used'
                eventKey='used'
                href={`/car-finder/catalog?view=grid&newSearch=used`}
              >
                Used
              </Nav.Link>
            </Nav.Item>
            ...
            <Row className='g-0 ms-lg-n2'>
              <Col lg={2}>
                <InputGroup className='border-end-lg border-light'>
                  <InputGroup.Text
                    id='search-icon'
                    className='text-muted ps-2 ps-sm-3'
                  >
              ...
              <Col sm={6} md={3} lg={2}>
                <DropdownSelect
                  ...
                  icon='fi-list'
                  options={[
                    [null, 'Altima'], // First element is an icon class, null means no i,
                    [null, 'Juke'],
                    [null, 'Leaf'],
                    [null, 'Maxima'],
                    [null, 'Micra'],
              ...
              <hr className='hr-light d-lg-none my-2' />
              <Col lg={2}>
                <Button className='w-100' onClick={searchSpecification}>
                  Search
                </Button>
              </Col>
            </Row>
      ...
      <Container as='section' className='pb-5 mb-md-4'>
        <div className='d-sm-flex align-items-center justify-content-between mb-3 mb-sm-4 pb-sm-2'>
          ...
          <Button
            ...
            variant='link btn-light fw-normal px-0'
          >
            View all
      ...
      <Container as='section' className='pt-4 pt-md-5'>
        ...
        <Row>
          <Col
            md={5}
            lg={{ span: 4, offset: 1 }}
            className='pt-4 mt-2 pt-md-5 mt-md-3'
          >
            <div className='d-flex pb-4 pb-md-5 mb-2'>
              ...
              <div className='text-md-end ps-3 ps-md-0 pe-md-3 order-md-1'>
                ...
                <p className='fs-sm text-light opacity-70 mb-0'>
                  That&apos;s more than you&apos;ll find on any other major
                  online automotive marketplace in the USA.
                </p>
              </div>
            </div>
            <div className='d-flex pb-4 pb-md-5 mb-2'>
              ...
              <div className='text-md-end ps-3 ps-md-0 pe-md-3 order-md-1'>
                ...
                <p className='fs-sm text-light opacity-70 mb-0'>
                  Our powerful search makes it easy to personalize your results
                  so you only see the cars and features you care about.
                </p>
              </div>
            </div>
            <div className='d-flex pb-4 pb-md-5 mb-2'>
            ...
            >
              ...
              <div className='position-absolute top-0 start-50 translate-middle-x h-100 overflow-hidden mt-n5'>
                ...
                >
                  ...
                  />
                  <g fillOpacity='.16'>
                    <path fill='#fff' d='M2,18.9H0L0,0h2V18.9z' />
                    <path fill='#fff' d='M2,52.5H0l0-18.9h2V52.5z' />
                    <path fill='#fff' d='M2,86H0l0-18.9h2V86z' />
                    <path fill='#fff' d='M2,119.6H0l0-18.9h2V119.6z' />
                    <path fill='#fff' d='M2,153.1H0l0-18.9h2V153.1z' />
                    <path fill='#fff' d='M2,186.7H0l0-18.9h2V186.7z' />
                    <path fill='#fff' d='M2,220.2H0l0-18.9h2V220.2z' />
                    <path fill='#fff' d='M2,253.8H0l0-18.9h2V253.8z' />
                    <path fill='#fff' d='M2,287.3H0l0-18.9h2L2,287.3z' />
                    <path fill='#fff' d='M2,320.8H0l0-18.9h2v9.5V320.8z' />
                  </g>
                </svg>
              </div>
            </div>
      ...
      <Container as='section' className='pt-sm-5 pt-4 pb-3'>
        <div className='d-sm-flex align-items-center justify-content-between mb-3 mb-sm-4 pb-2'>
          ...
          <div className='d-flex align-items-center'>
            <Nav
              variant='tabs'
              className='nav-tabs-light fs-sm me-4 pe-2 mb-0'
      ...
      <Container as='section' className='pt-4 pb-5 py-sm-5'>
          ...
          <SwiperSlide>
            <div className='card card-body p-sm-5 card-light h-100'>
              <Row className='align-items-center py-3 py-sm-0'>
                <Col
                  md={6}
                  className='mb-4 pb-3 mb-md-0 pb-md-0 text-center text-md-start'
                >
                  <h2 className='text-light'>Car sale in 24 hours</h2>
                  <p className='fs-lg text-light opacity-70 pb-md-4'>
                    Calculate your car&apos;s value, then choose how you want to
                    sell.
                  </p>
                ...
                <Col md={8} xl={9}>
                  <Row xs={2} lg={4} className='gy-4 gx-3 gx-sm-4'>
                    ...
                    >
                      ...
                      <div className='fw-bold text-center pt-1'>
                        Seat Covers
                      </div>
                    </Col>
                    <Col
        ...
        <div className='d-flex pt-4 pb-2'>
          <Button
            id='ctaPrev'
            variant='prev btn-light position-relative me-3'
          />
      ...
      <Container as='section' className='pb-4 pb-sm-5 mb-2 mb-md-4'>
        ...
        <div
          id='bulletsBlog'
          className='swiper-pagination swiper-pagination-light position-relative bottom-0 mt-4 pb-3'
        ></div>
      </Container>
    </CarFinderPageLayout>
  )
