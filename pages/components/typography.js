...
<h1 className='display-6'>Display 6</h1>`}</Code>
      ...
      <ComponentPageSection id='type-body-text' title='Body text sizes'>
        <Tab.Pane eventKey='preview'>
          <p className='fs-1'>
            <strong>fs-1.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-2'>
            <strong>fs-2.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-3'>
            <strong>fs-3.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-4'>
            <strong>fs-4.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-5'>
            <strong>fs-5.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-6'>
            <strong>fs-6.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='lead'>
            <strong>Lead.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-lg'>
            <strong>Large.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p>
            <strong>Normal.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-sm'>
            <strong>Small.</strong> Vivamus sagittis lacus vel augue laoreet
            rutrum faucibus dolor auctor
          </p>
          <p className='fs-xs'>
            <strong>Medium small.</strong> Vivamus sagittis lacus vel augue
            laoreet rutrum faucibus dolor auctor
          </p>
          <p className='fs-xxs'>
            <strong>Extra small.</strong> Vivamus sagittis lacus vel augue
            laoreet rutrum faucibus dolor auctor
          </p>
        </Tab.Pane>
        <Tab.Pane eventKey='code'>
...
<p><abbr className='initialism' title='HyperText Markup Language'>HTML</abbr></p>`}</Code>
      ...
      <ComponentPageSection id='type-blockquote' title='Blockquote'>
        <Tab.Pane eventKey='preview'>
          <Blockquote
            author={{ name: 'Someone famous in Source Title' }}
            className='mb-4'
          >
